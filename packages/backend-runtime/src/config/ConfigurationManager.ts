...
class ConfigurationManager {
  ...
  public static getAiDailyNeuronFreeTierLimit(env: unknown): number {
    return ConfigurationManager.getPositiveInt(env, 'AI_DAILY_NEURON_FREE_TIER_LIMIT', DEFAULT_AI_DAILY_NEURON_FREE_TIER_LIMIT);
  }
